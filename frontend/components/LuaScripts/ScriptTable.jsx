...
const ScriptCodeCell = React.memo(
  ({ value, row: { original }, onEditScript }) => (
    <div
      onDoubleClick={() => onEditScript(original.id)}
  ...
  ({
    ...
    const commonColumns = useMemo(
      () => [
        ...
        },
        {
          ...
          width: 40,
          Cell: (props) => (
            <ScriptCodeCell {...props} onEditScript={onEditScript} />
          ),
        },
        {
          Header: 'Log',
          ...
          width: 12,
          Cell: (props) => (
            <LogToggleCell {...props} onClearLog={onClearScriptLog} />
          ),
        },
        {
          Header: 'Actions',
    ...
    const {
    ...
    } = useTable(
      {
        ...
        getSubRows: (row) =>
          row.isExpanded
            ? [{ id: `${row.id}-log`, isLogRow: true, log: row.original.log }]
            : [],
        state: { expanded },
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            {onExportPackage && scripts.length > 0 && (
              <AddSectionButton
                onClick={() => onExportPackage(scripts)}
